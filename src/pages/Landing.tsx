...
const Landing = () => {
  ...
  const navigateImage = (direction: 'prev' | 'next') => {
    ...
    if (direction === 'prev') {
      setSelectedImage(selectedImage === 0 ? archivePhotos.length - 1 : selectedImage - 1);
    } else {
      setSelectedImage(selectedImage === archivePhotos.length - 1 ? 0 : selectedImage + 1);
    }
  };
  ...
  return (
    <div className="min-h-screen flex flex-col overflow-x-hidden font-sans leading-relaxed">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <div className="group relative rounded-2xl p-8 bg-card border-2 hover:border-primary/50 transition-all hover:shadow-xl">
              ...
              <ul className="list-disc pl-5 text-sm md:text-base text-foreground/85 space-y-2">
                ...
                <li>Each entry displays its consent level — Public, Restricted, or Confidential</li>
                <li>Access detailed descriptions, audio clips, videos and cultural content</li>
            ...
            <div className="group relative rounded-2xl p-8 bg-card border-2 hover:border-primary/50 transition-all hover:shadow-xl">
              ...
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-xl md:text-2xl font-semibold">Contribute Ethically</h3>
              </div>
              <ul className="list-disc pl-5 text-sm md:text-base text-foreground/85 space-y-2">
                <li>Share your own cultural content as text, image, audio, or video</li>
                <li>Ensure you have clear community consent before uploading</li>
                <li>Fill in required metadata: category, tribe, region, and description</li>
            ...
            <div className="group relative rounded-2xl p-8 bg-card border-2 hover:border-primary/50 transition-all hover:shadow-xl">
              ...
              <div className="flex items-center gap-3 mb-4">
                <span className="flex items-center justify-center w-10 h-10 rounded-full bg-primary text-primary-foreground font-bold text-lg">3</span>
                <h3 className="text-xl md:text-2xl font-semibold">Follow the Roadmap</h3>
              </div>
              <ul className="list-disc pl-5 text-sm md:text-base text-foreground/85 space-y-2">
                <li>Collection: Gathering Folk Stories with consent</li>
                <li>Verification: Elders and experts ensure accuracy</li>
                <li>Publication: Approved items published with tiered access</li>
              </ul>
            </div>
          </div>
      ...
      {/* Roadmap */}
      <section ref={roadmapRef} className="relative py-20 md:py-32 bg-muted/30 border-t border-border/60">
        <div className="relative max-w-7xl mx-auto px-4">
          <div className="mb-16 text-center">
            <h2 className="text-3xl md:text-5xl font-bold heading-accent inline-block">Heritage Repository Roadmap</h2>
            <p className="mt-4 md:mt-6 text-base md:text-lg text-muted-foreground max-w-3xl mx-auto">
              A clear path from collection to publication — transparent, consent-based, and authentic.
            </p>
          </div>
          ...
          <div className="max-w-4xl mx-auto space-y-8">
            <div className="flex flex-col md:flex-row gap-8 items-start">
              ...
              <div className="flex-1">
                <div className="inline-flex items-center gap-3 mb-4">
                  <span className="flex items-center justify-center w-12 h-12 rounded-full bg-primary text-primary-foreground font-bold text-xl">1</span>
                  <h3 className="text-2xl md:text-3xl font-bold text-primary">Collection</h3>
                </div>
                <p className="text-base md:text-lg text-foreground/90 leading-relaxed">
                  Community members document Folksongs, Folktales, Ritual Practices and Material Culture with informed consent from the knowledge holders.
                </p>
            ...
            <div className="flex flex-col md:flex-row gap-8 items-start">
              ...
              <div className="flex-1">
                <div className="inline-flex items-center gap-3 mb-4">
                  <span className="flex items-center justify-center w-12 h-12 rounded-full bg-primary text-primary-foreground font-bold text-xl">3</span>
                  <h3 className="text-2xl md:text-3xl font-bold text-primary">Publication</h3>
                </div>
                ...
                <p className="mt-4 text-sm md:text-base text-muted-foreground italic">
                  Goal: Protect Cultural Knowledge while promoting awareness and continuity
                </p>
              </div>
            </div>
          </div>
      ...
      <section ref={visualsRef} className="relative py-20 md:py-32 bg-background border-t border-border/60">
        <div className="relative max-w-7xl mx-auto px-4">
          <div className="mb-16 text-center">
            <h2 className="text-3xl md:text-5xl font-bold heading-accent inline-block">Photos from the Archive</h2>
            <p className="mt-4 md:mt-6 text-base md:text-lg text-muted-foreground max-w-3xl mx-auto">
              A glimpse of real visual stories. Click any image to view in full screen.
            </p>
          </div>
      ...
      <section className="relative py-20 md:py-24 bg-muted/30">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h3 className="text-2xl md:text-4xl font-bold mb-4">Join us in safeguarding living heritage</h3>
          <p className="text-base md:text-lg text-muted-foreground mb-8">
            Your curiosity and care help traditions thrive for generations to come.
          </p>
