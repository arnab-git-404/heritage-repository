        ...
        <Card>
          <CardContent className="p-0">
            {loading ? (
              ...
              <EmptyState hasFilters={hasFilters} onUpload={() => navigate("/user/dashboard/upload")} />
            ) : (
                      ...
                      return (
                        ...
                        >
                          <TableCell>
                            <div
                              className="space-y-1"
                              onClick={() => navigate(`/user/dashboard/profile/submissions/${submission._id}`)}
                            >
                                  ...
                                  <Tooltip>
                                    <TooltipTrigger asChild>
                                      <Button
                                        ...
                                        size="sm"
                                        onClick={() =>
                                          navigate(`/user/dashboard/profile/submissions/${submission._id}/history`)
                                        }
                                      >
